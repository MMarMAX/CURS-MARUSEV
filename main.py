...
btn1 = Button(root, text="Добавить книгу", bg='white', fg='#1890ec', font=("Arial Black", 13), command=btnAddBook)
btn1.place(relx=0.29, rely=0.39, relwidth=0.43, relheight=0.1)
btn2 = Button(root, text="Удалить книгу", bg='white', fg='#1890ec', font=("Arial Black", 13))
btn2.place(relx=0.29, rely=0.49,relwidth=0.43, relheight=0.1)
btn3 = Button(root, text="Просмотреть книги \n в библиотеке", bg='white', fg='#1890ec', font=("Arial Black", 13))
btn3.place(relx=0.29, rely=0.59, relwidth=0.43, relheight=0.1)
btn4 = Button(root, text="Выдать книгу студенту", bg='white', fg='#1890ec', font=("Arial Black", 13))
btn4.place(relx=0.29, rely=0.69, relwidth=0.43, relheight=0.1)
btn5=Button(root, text="Возврат книги", bg='white', fg='#1890ec', font=("Arial Black",13))
